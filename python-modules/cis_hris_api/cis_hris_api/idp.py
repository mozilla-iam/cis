...
from cis_hris_api.exceptions import AuthError

logger = logging.getLogger(__name__)

CONFIG = get_config()

AUTH0_DOMAIN = CONFIG('auth0_domain', namespace='hris_api', default='auth-dev.mozilla.auth0.com')
API_IDENTIFIER = CONFIG('api_identifier', namespace='hris_api', default='https://hris-api.sso.allizom.org')
ALGORITHMS = CONFIG('algorithms', namespace='hris_api', default='RS256')
...
def requires_auth(f):
    ...
    def decorated(*args, **kwargs):
        ...
        jwt_validation = CONFIG('jwt_validation', namespace='hris_api', default='true')
